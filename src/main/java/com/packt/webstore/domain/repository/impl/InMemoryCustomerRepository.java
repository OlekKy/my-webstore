...
public class InMemoryCustomerRepository implements CustomerRepository {
	...
	public InMemoryCustomerRepository() {
		...
		Customer user1 = new Customer ("1001","Zakupujacy48");
		user1.setNoOfOrdersMade(4);
		
		Customer user2 = new Customer ("1002","Buyer72");
		user2.setNoOfOrdersMade(0);
		
		Customer user3 = new Customer ("1003","KupieOpla12");
		user3.setNoOfOrdersMade(2);
		
		Customer user4 = new Customer ("1004","Bogaty8");
		user4.setNoOfOrdersMade(3);
		
		Customer user5 = new Customer ("1005","Zebra23");
